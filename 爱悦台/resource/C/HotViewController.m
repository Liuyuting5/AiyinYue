...
@interface HotViewController ()<UITableViewDelegate,UITableViewDataSource,MBProgressHUDDelegate>
{   MBProgressHUD *_HUD;
    NSInteger _offset;
    NSString *code;
    NSArray *areaModels;
...
- (void)viewDidLoad {
    ...
    [DownLoadData getHotAreaDataWithBlock:^(NSArray *areaModel, NSError *error)  {
