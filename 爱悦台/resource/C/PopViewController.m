...
@interface PopViewController ()<UITableViewDelegate,UITableViewDataSource,MBProgressHUDDelegate>
{   MBProgressHUD *_HUD;
    NSInteger _offset;
    NSString *code;
    NSArray *areaModels;
...
- (void)viewDidLoad {
    ...
    [DownLoadData getPopAreaDataWithBlock:^(NSArray *areaModel, NSError *error)  {
